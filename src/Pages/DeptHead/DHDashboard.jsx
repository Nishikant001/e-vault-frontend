  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <StatCard label="Approvals" value={PENDING_APPROVALS.length} sub="Pending review" subColor="text-amber-600 dark:text-amber-400" icon="✅" />
            ...
            <div className="space-y-2">
              {recent.map((doc) => (
                <div key={doc.id} className="flex items-center gap-3 p-2 rounded-lg border border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                  ...
                  <span className="text-[10px] font-bold px-2 py-[2px] rounded-full border bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 border-blue-200 dark:border-blue-800">{doc.DocumentType?.name || "Doc"}</span>
