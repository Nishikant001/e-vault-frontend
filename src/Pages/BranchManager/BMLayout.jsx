  ...
  return (
    <button
      ...
      className={`group flex items-center gap-[10px] w-[calc(100%-20px)] mx-[10px] my-[2px] px-3.5 py-[10px] rounded-[9px] text-[13px] font-medium transition-all duration-150 ${
        active ? "bg-gradient-to-r from-blue-500/25 to-blue-500/[0.06] text-[#6FB6FF] shadow-[inset_2.5px_0_0_0_#3B82F6]" : "text-white/60 hover:bg-white/[0.05] hover:text-white/90"
      }`}
    >
      ...
      {item.badge && (
        <span className={`text-[10px] font-bold px-[8px] py-[2px] rounded-full ${active ? "bg-blue-500 text-white" : "bg-blue-900/40 text-blue-300"}`}>
          {item.badge}
        </span>
      )}
    </button>
    ...
    <>
      ...
      <aside className={`fixed top-0 left-0 h-full z-40 flex flex-col w-[252px] bg-[#1A2433] transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"} lg:static lg:translate-x-0 lg:flex-shrink-0`}>
        ...
        <div className="flex items-center gap-[10px] px-[18px] py-[14px] border-b border-white/[0.08] bg-white/[0.015]">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-[11px] font-bold text-white flex-shrink-0 ring-2 ring-white/10">BM</div>
          <div>
            <div className="text-white/90 text-[12px] font-semibold">{user?.u || "branchmanager"}</div>
            <div className="text-white/40 text-[10.5px] font-medium mt-px">BranchManager</div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-3 space-y-[2px]">
          ...
          <div className="px-[18px] pt-5 pb-[9px] text-[11px] font-bold text-white/35 uppercase tracking-[0.9px]">Reports</div>
...
function Topbar({ title, onMenuClick, onLogout }) {
  ...
  return (
    <header className="h-[60px] bg-white dark:bg-[#1A2433] border-b border-slate-200 dark:border-slate-700 flex items-center px-5 gap-4 flex-shrink-0 sticky top-0 z-20 transition-colors">
      ...
      <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-[11px] font-bold px-[12px] py-[5px] rounded-full hidden sm:inline tracking-[0.2px]">BranchManager</span>
